...
let responseData;
let DB_NAME = "jobportal";
let COLLECTION_NAME = "JobPortal"
async function main() {
    const uri = `mongodb+srv://poojitha:poojitha0306@cluster0.rujh68i.mongodb.net/${DB_NAME}?retryWrites=true&w=majority`;
...
const PORT = process.env.PORT || 9038;
